...
from sentry.models import Group, GroupHash, GroupStatus
...
def delete_group_list(user, project, group_list, delete_type, request):
    if not group_list:
        return
    ...
    for group in group_list:
        ...
        issue_deleted.send_robust(
            group=group, user=user, delete_type=delete_type, sender=delete_group_list
        )


def delete_groups(user, group_ids, projects, organization_id, search_fn, request):
    """
